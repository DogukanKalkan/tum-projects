...
class MyPytorchModel(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.model = nn.Sequential(
            nn.Linear(in_features=input_size, out_features=hparams['first_layer']),
            nn.BatchNorm1d(num_features=hparams['first_layer']),
            nn.ReLU(),
            nn.Dropout(p=hparams['dropout']),

            nn.Linear(in_features=hparams['first_layer'], out_features=hparams['second_layer']),
            nn.BatchNorm1d(num_features=hparams['second_layer']),
            nn.ReLU(),
            nn.Dropout(p=hparams['dropout']),

            nn.Linear(in_features=hparams['second_layer'], out_features=hparams['third_layer']),
            nn.BatchNorm1d(num_features=hparams['third_layer']),
            nn.ReLU(),
            nn.Dropout(p=hparams['dropout']),

            nn.Linear(in_features=hparams['third_layer'], out_features=num_classes),
        )
