...
class DataLoader:
    ...
    def __iter__(self):
        ...
        def batch_to_numpy_dicts(batch):
            batch_dict = {}
        ...
        for index in index_iterator:  # iterate over indices using the iterator
            ...
            if len(batch) == self.batch_size:
                batch = batch_to_numpy_dicts(batch)
    ...
    def __len__(self):
        ...
        num_batches = np.floor_divide(len(self.dataset), self.batch_size)
        length = num_batches if self.drop_last == True else num_batches + 1
