...
class TNet(nn.Module):
    def __init__(self, k):
        ...
        self.conv1 = torch.nn.Conv1d(in_channels=k, out_channels=64, kernel_size=1)
        ...
        self.fc3 = torch.nn.Linear(in_features=256, out_features=k**2)
...
class PointNetClassification(nn.Module):
    def __init__(self, num_classes):
        ...
        self.fc1 = torch.nn.Linear(in_features=1024, out_features=512)
        self.fc2 = torch.nn.Linear(in_features=512, out_features=256)
        self.fc3 = torch.nn.Linear(in_features=256, out_features=num_classes)
    ...
    def forward(self, x):
        ...
        x = self.fc3(x) # No Batch Norm and ReLU after the last linear layer.
        return x
...
class PointNetSegmentation(nn.Module):
    def __init__(self, num_classes):
        ...
        self.conv4 = torch.nn.Conv1d(in_channels=128, out_channels=50, kernel_size=1) #m=50
