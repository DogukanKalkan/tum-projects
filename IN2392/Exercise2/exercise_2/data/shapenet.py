...
class ShapeNetVox(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Example shape: 04379243/d120d47f8c9bc5028640bc5712201c4a
...
class ShapeNetPoints(torch.utils.data.Dataset):
    ...
    def get_point_cloud(shapenet_id):
        ...
        path = f"{dataset_path}/{category_id}/{shape_id}.obj"
        return np.array(trimesh.load(path).vertices, dtype=np.float32).T
